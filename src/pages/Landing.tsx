              ...
              {([
                {
                  ...
                  title: "Universe",
                  ml: false,
                  desc: "We screen 800+ US-listed assets down to a liquid, fundamentally-sound investable pool.",
                  stats: ["800+ assets screened", "Liquidity filters", "Sector-aware"],
                },
                {
                  n: "02",
                  title: "Signals",
                  ml: false,
                  desc: "Quantitative models score each asset using technical signals — momentum, trend, and mean reversion — with fundamental filters applied as a secondary gate.",
                  stats: ["171 models", "Technical + fundamental", "No discretion"],
                },
                {
                  n: "03",
                  title: "Regime detection",
                  ml: true,
                  desc: "A machine learning layer reads the current market environment and adjusts which signals to trust.",
                  stats: ["Bear / Bull Low Vol / Bull High Vol", "Sector-level detection"],
                },
                {
                  n: "04",
                  title: "Selection",
                  ml: false,
                  desc: "The best-performing strategies are validated out-of-sample and used to rank each asset.",
                  stats: ["Walk-forward validated", "No lookahead bias"],
                },
                {
                  n: "05",
                  title: "Portfolio",
                  ml: false,
                  desc: "The top 15 assets are held equally-weighted and rebuilt from scratch every two months.",
                  stats: ["15 equal-weight positions", "Bi-monthly rebalance"],
                },
